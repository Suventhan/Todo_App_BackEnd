...
const deleteTodo = async (req: Request, res: Response): Promise<void> => {
    try {
        ...
        res.status(200).json({ message: "Todo deleted Successfully", todo: deletedTodo, todos: allTodos })
    } catch (error) {
        throw error
    }
}
...
const updateTodo = async (req: Request, res: Response): Promise<void> => {
    try {
        ...
        res.status(200).json({ message: "Todo updated Successfully", todo: updateTodo, todos: allTodos })
    } catch (error) {
        throw error
    }
}
